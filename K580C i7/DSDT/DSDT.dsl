 ...
 *
 * Disassembly of DSDT.aml, Sat Jan 17 11:08:41 2015
 *
            ...
            Device (LPCB)
            {
                ...
                Scope (\_SB)
                {
                    ...
                    Device (WMI2)
                    {
                        ...
                        CreateWordField (BUFF, 0x14, SPD0)
                        CreateWordField (BUFF, 0x15, SPD1)
...
P8XH (0x04, 0x52, Zero)
        ...
        If (LEqual (Arg0, 0x03))
        {
            ...
            Else
            {
                If (\_SB.PCI0.EHC1.PWU2)
                {
                    Store (One, \_SB.PCI0.LPCB.EC0.USBW)
                }
                Else
                {
                    If (\_SB.PCI0.EHC1.PWU3)
                    {
                        Store (One, \_SB.PCI0.LPCB.EC0.USBW)
                    }
                    Else
                    {
                        If (\_SB.PCI0.EHC2.PWU1)
                        {
                            Store (One, \_SB.PCI0.LPCB.EC0.USBW)
                        }
                        Else
                ...
                If (LGreaterEqual (OSYS, 0x07D6))
                {
                    ...
                    While (One)
                    {
                        ...
                        If (LEqual (T_0, Zero))
                        {
                            ...
                            Return (Add (0x0AAC, Multiply (DerefOf (Index (DerefOf (Index (QGTP, TJID)), One
                                )), 0x0A)))
                        }
                        Else
                        {
                            Store (DerefOf (Index (DerefOf (Index (QQTP, TJID)), One)), HOTP)
                            Return (Add (0x0AAC, Multiply (DerefOf (Index (DerefOf (Index (QQTP, TJID)), One
                                )), 0x0A)))
                        }
            ...
            Method (_CRT, 0, Serialized)  // _CRT: Critical Temperature
            {
                ...
                If (LLess (OSYS, 0x07D6))
                {
                    ...
                    While (One)
                    {
                        ...
                        If (LEqual (T_0, Zero))
                        {
                            Return (Add (0x0AAC, Multiply (DerefOf (Index (DerefOf (Index (QGTP, TJID)), 0x02
                                )), 0x0A)))
                        }
                        Else
                        {
                            Return (Add (0x0AAC, Multiply (DerefOf (Index (DerefOf (Index (QQTP, TJID)), 0x02
                                )), 0x0A)))
                        }
            ...
            Method (_PSV, 0, Serialized)  // _PSV: Passive Temperature
            {
                ...
                Else
                {
                    While (One)
                    {
                        ...
                        If (LEqual (T_1, Zero))
                        {
                            Return (Add (0x0AAC, Multiply (DerefOf (Index (DerefOf (Index (QGTP, TJID)), Zero
                                )), 0x0A)))
                        }
                        Else
                        {
                            Return (Add (0x0AAC, Multiply (DerefOf (Index (DerefOf (Index (QQTP, TJID)), Zero
                                )), 0x0A)))
                        }
    ...
    Scope (_SB.PCI0)
    {
        ...
        Device (HDEF)
        {
            ...
            Method (_DSM, 4, NotSerialized)
            {
                ...
                Return (Package()
                {
                    "layout-id", Buffer() { 76, 0x00, 0x00, 0x00 },
                    "AFGLowPowerState", Unicode ("\x01"), 
